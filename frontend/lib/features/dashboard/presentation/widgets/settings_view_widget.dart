          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDialogField(context, 'Full Name', 'e.g. Aryan Sharma',
                    controller: nameCtrl),
                const SizedBox(height: 14),
                _buildDialogField(context, 'Date of Birth', 'YYYY-MM-DD',
                    controller: dobCtrl, hint: 'e.g. 2003-05-26'),
                const SizedBox(height: 14),
                _buildReadOnlyField(context, 'Email Address', email),
                const SizedBox(height: 14),
                if (rollNumber.isNotEmpty)
                  _buildReadOnlyField(context, 'Roll Number', rollNumber),
              ],
            ),
          ),
          actions: [
        ...
        builder: (context, setState) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              _buildDialogField(context, 'Current Password', '••••••••',
                  controller: currentController, obscure: true),
              const SizedBox(height: 16),
              _buildDialogField(context, 'New Password', '',
                  controller: newController, obscure: true),
              const SizedBox(height: 16),
              _buildDialogField(context, 'Confirm New Password', '',
          ...
          child: Row(
            children: [
              ...
              Icon(Icons.lock_outline,
                  size: 14,
                  color:
                      AppColors.getBodyColor(context).withValues(alpha: 0.4)),
            ],
          ),
        ),
      ],
              ...
              child: Column(
                children: [
                  ...
                  _buildToggleTile(
                    ...
                    (val) => ref
                        .read(isNotificationsEnabledProvider.notifier)
                        .set(val),
                  ...
                  _buildToggleTile(
                    ...
                    emailSummaryEnabled,
                    (val) => ref
                        .read(isEmailSummaryEnabledProvider.notifier)
                        .set(val),
      ...
      child: Row(
        children: [
          Container(
            ...
            child:
                Icon(icon, color: AppColors.getHeadingColor(context), size: 20),
          ),
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color:
                    (isDanger ? Colors.red : AppColors.getBorderColor(context))
